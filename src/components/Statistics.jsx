    ...
    return (
        <div className={'max-w-[1216px] mx-auto'}>
            <div>
                ...
                <div className={'md:flex justify-center items-center text-[#4F46E5] md:mx-auto gap-5'}>
                    <div className={'text-center'}>
                        <h1 className={'text-[60px] font-semibold '}>420%</h1>
                        <p>Data Efficiency</p>
                    </div>
                    <div className={'text-center'}>
                        <h1 className={'text-[60px] font-semibold '}>708+</h1>
                        <p>Conversion Rate</p>
                    </div>
                    <div className={'text-center'}>
                        <h1 className={'text-[60px] font-semibold '}>1.82M</h1>
                        <p>AI LLM Scale</p>
                    </div>
                </div>
            </div>
